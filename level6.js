...
{pts:5,domains:["연산"], semester:[1]},
{pts:5,domains:["연산"], semester:[1]},
{pts:6,domains:["연산"], semester:[1]},
{pts:7,domains:["규칙논리"], semester:[1]},
{pts:6,domains:["연산","규칙논리"], semester:[1]},
{pts:6,domains:["연산"], semester:[1]},
{pts:7,domains:["도형"], semester:[2]},
{pts:6,domains:["연산"], semester:[1]},
{pts:7,domains:["측정","연산"], semester:[1]},
{pts:5,domains:["도형","측정","연산"], semester:[1,2]},
{pts:7,domains:["도형","측정"], semester:[1]},
{pts:5,domains:["규칙논리"], semester:[2]},
{pts:7,domains:["연산"], semester:[2]},
{pts:7,domains:["연산"], semester:[2]},
{pts:7,domains:["도형","측정"], semester:[2]}
...
qs.forEach((q,i)=>{
  ...
  // 각 문항의 학기에 점수와 최대값 누적
meta.semester.forEach(s => {

  semesterAgg[s].score += correct;
  semesterAgg[s].max += 1;
